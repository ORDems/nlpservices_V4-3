<?php
/**
 * Name: voterdb_hd_fix.php    V4.2    6/5/18
 * 
 */
 ...
 * @return $form
 */
function voterdb_hd_fix_form($form, &$form_state) {
 ...
 * @return boolean
 */
function voterdb_hd_fix_form_validate($form, &$form_state) {
 ...
 * @param type $form_state
 */
function voterdb_hd_fix_form_submit($form, &$form_state) {
